describe('Rooms Management Page', () => {
  it('should search and show room detail correctly', () => {
    ...
    // ด้านขวาต้องขึ้นรายละเอียดห้อง 101
    cy.get('body').then($body => {
    ...
    // ด้านขวาต้องเปลี่ยนเป็นรายละเอียดห้อง 110
    cy.get('body').then($body => {
